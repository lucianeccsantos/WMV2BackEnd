...
{
    public class ColaboradorUpdatedEvent : Event
    {
        public ColaboradorUpdatedEvent(Guid id, string login, string nome, Guid cargoId, string cpf, Guid dependenciaId, Guid perfilId,
